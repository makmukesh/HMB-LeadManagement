...
public class NotificationHistoryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            act = NotificationHistoryActivity.this;
...
*/
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, "Select_NotificationByStaffID", TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(NotificationHistoryActivity.this);
        }
        System.gc();
    }
