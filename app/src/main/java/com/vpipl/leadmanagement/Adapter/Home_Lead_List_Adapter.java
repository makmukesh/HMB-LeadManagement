...
public class Home_Lead_List_Adapter extends RecyclerView.Adapter<Home_Lead_List_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_List;
    LayoutInflater inflater = null;
    Context context;
    private TextDrawable.IBuilder mDrawableBuilder;

    public Home_Lead_List_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_List = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(inflater.inflate(R.layout.adapter_home_lead_list, parent, false));
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            holder.txt_cust_mobileno.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", array_List.get(position).get("cust_mobileno"), null));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txt_lead_first_letter, txt_lead_title, txt_cust_name, txt_lead_time, txt_cust_mobileno, txt_lead_status;
